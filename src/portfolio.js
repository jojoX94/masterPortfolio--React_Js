...
const greeting = {
  ...
  portfolio_repository: "https://github.com/jojoX94/CarRental--React_Native",
...
const skills = {
  data: [
    //TODO: Uncomment the following lines and add your skills accordingly if you want to use Skill Section
    // {
      ...
      experiences: [
        {
          ...
          company: "Ingenosya Inc.",
          company_url: "https://www.ingenosya.com/",
          logo_path: "ingenosya_logo.png",
          duration: "Sept 2021 - Feb 2022",
          location: "Antananarivo, Madagascar",
          description:
            "Developing an Africa-focused online marketplace using ReactJS and NodeJS, incorporating Material UI React for CSS and MongoDB for database, while enhancing backend recommendation systems encompassing ranking algorithms for wide-reaching Ads, and refining content ranking methods via intensive sample data replays for training iterations.",
          color: "#000000",
        },
      ],
    },
